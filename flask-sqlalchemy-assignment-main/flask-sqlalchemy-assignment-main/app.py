...
# https://flask-sqlalchemy.palletsprojects.com/en/2.x/api/ USED 
# https://docs.sqlalchemy.org/en/14/orm/query.html USED
# https://pypi.org/project/Flask-SQLAlchemy/ USED
app = Flask(__name__)

# TODO: DB connection
app.config['SQLALCHEMY_DATABSE_URI']='mysql://root:@localhost:3306/movies'
